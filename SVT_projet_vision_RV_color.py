...
Renvoie un tableau donnant l'exactitude de la réponse (colonnes "results": 1=réponse
correcte; 0=réponse fausse) et les temps de réaction (colonnes RT) en fonction de
la position de la cible (colonne "pos_indx"),
...
0=cible absente).
Cette expérience devrait résulter facile (en tout cas plus facile de la suivante
, sur la recherche visuelle dite de "conjonction d'attributs").
Pour passer l'expérience, chaque étudiant doit se mettre bien devant l'écran et
se concentrer pendant toute la durée. Il faut essayer de donner
...
absente et dans cette experience plutôt que dans l’autre experience de recherche
visuelle.
...
Le but de cette expérience est de dire si la lettre de couleur rouge est presentée (ou pas)
parmi des distracteurs (des lettres de couleur vert), tout en gardant bien l'oeil fixé sur la croix centrale.
